...
*/
faust.clarinetMIDI = function (dsp_instance, context, buffer_size) {
...
*/
faust.createclarinetMIDI = function(context, buffer_size, callback)
{
    var importObject = {
        env: {
            memoryBase: 0,
    ...
    .then(dsp_module => callback(faust.clarinetMIDI(dsp_module.instance, context, buffer_size)))
    .catch(function(error) { console.log(error); faust.error_msg = "Faust clarinetMIDI cannot be loaded or compiled"; callback(null); });
}
